...
abstract class AbstractModule implements Module {
    ...
    private void writeZipped(File file, Closure cl) {
        def bos = new ByteArrayOutputStream()
        writeContents(bos, cl)

        ZipOutputStream zipStream = new ZipOutputStream(file.newOutputStream())
        try {
    ...
    protected boolean isJarFile(File File) {
        return FilenameUtils.getExtension(File.getName()) == 'jar'
    }
